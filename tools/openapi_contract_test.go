...
func TestOpenAPIContainsAuthenticationFoundationOperations(t *testing.T) {
	...
	expected := map[operationKey]string{
		...
		{http.MethodGet, "/api/assets/gateways"}:                                               "listGatewayAssets",
		{http.MethodPost, "/api/assets/gateways"}:                                              "registerGatewayAsset",
		{http.MethodGet, "/api/assets/gateways/{instance_id}"}:                                 "getGatewayAssetById",
		{http.MethodPatch, "/api/assets/gateways/{instance_id}"}:                               "editGatewayAsset",
		{http.MethodPost, "/api/assets/gateways/{instance_id}/retire"}:                         "retireGatewayAsset",
		{http.MethodPost, "/api/assets/gateways/{instance_id}/replace"}:                        "replaceGatewayAsset",
		{http.MethodGet, "/api/assets/gateways/{instance_id}/health"}:                          "getGatewayHealth",
		{http.MethodPost, "/api/assets/gateways/{instance_id}/connection-test"}:                "testGatewayConnection",
		{http.MethodGet, "/api/assets/nodes"}:                                                  "listNodeAssets",
		{http.MethodPost, "/api/assets/nodes"}:                                                 "registerNodeAsset",
		{http.MethodGet, "/api/assets/nodes/{instance_id}"}:                                    "getNodeAsset",
		{http.MethodPatch, "/api/assets/nodes/{instance_id}"}:                                  "editNodeAsset",
		{http.MethodPost, "/api/assets/nodes/{instance_id}/retire"}:                            "retireNodeAsset",
		{http.MethodPost, "/api/assets/nodes/{instance_id}/replace"}:                           "replaceNodeAsset",
		{http.MethodGet, "/api/assets/nodes/{instance_id}/health"}:                             "getNodeHealth",
		{http.MethodPost, "/api/assets/nodes/{instance_id}/connection-test"}:                   "testNodeConnection",
		{http.MethodPost, "/api/assets/nodes/{instance_id}/monitoring-enable"}:                 "enableNodeMonitoring",
		{http.MethodPost, "/api/assets/nodes/{instance_id}/monitoring-disable"}:                "disableNodeMonitoring",
...
func TestOpenAPIAssetRegistryIsProtectedReadOnlyAndSecretFree(t *testing.T) {
	...
	assets := map[string]string{
		...
		"/api/assets/nodes/{instance_id}":       "#/components/schemas/NodeAssetDetailResponse",
