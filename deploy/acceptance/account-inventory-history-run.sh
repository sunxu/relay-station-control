...
run_static() {
  ...
  require_test ./internal/historyruntime TestRepositoryLoopsUsesConfiguredConcurrency
  require_test ./internal/historyruntime TestRepositoryLoopsFatalMismatchStopsPlannerAndNewWorkerTransactions
