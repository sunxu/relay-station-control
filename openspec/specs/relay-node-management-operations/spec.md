...
- **WHEN** active Node 的 protected management credential 未配置，或 runtime 无权读取 protected credential state
- **THEN** Health 与 Connection Test 仍可各执行一次 Probe，且 API、audit、metrics、log 与 receipt 均无 credential reference/value
